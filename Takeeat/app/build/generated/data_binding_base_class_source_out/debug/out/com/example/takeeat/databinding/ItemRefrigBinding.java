...
public final class ItemRefrigBinding implements ViewBinding {
  ...
  @NonNull
  public static ItemRefrigBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemRefrigBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_refrig, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemRefrigBinding bind(@NonNull View rootView) {
